...
/**
 * Models an interface for an algorithm to compute all optima for an
 * uniobjective optimization problem
 *
 ...
 */
public interface UniobjectiveAllAlgorithm<N extends Node, E extends Edge, G extends Graph<N, E, G>, GE extends GraphElement> {
	 ...
	 * @return iterable object, which contains iterable objects of edges, which
	 *         represent an optima
	 */
	public Iterable<Iterable<E>> computeAllUniobjectiveOptima(G graph,
